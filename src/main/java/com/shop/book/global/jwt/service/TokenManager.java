package com.shop.book.global.jwt.service;


import com.shop.book.domain.member.constant.Role;
import com.shop.book.global.error.ErrorCode;
import com.shop.book.global.error.exception.AuthenticationException;
import com.shop.book.global.jwt.constant.GrantType;
import com.shop.book.global.jwt.constant.TokenType;
import com.shop.book.global.jwt.dto.JwtTokenDto;
...
public class TokenManager {
    ...
    public JwtTokenDto createJwtToeknDto(Long memberId, Role role){
        ...
        return JwtTokenDto.builder()
                ...
                .refreshToeknExpireTime(refreshTokenExpireTime)
                .build();
    ...
    public void validateTOken(String token){
        try{
            ...
            log.info("유효하지않은 token", e);
            throw new AuthenticationException(ErrorCode.NOT_VALID_TOKEN);
        }
    }


    //페이로드에있는 정보를 가져오는 메서드
